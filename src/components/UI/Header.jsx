 ...
 *
 * Contains the application logo and title. A back button is displayed automatically on all pages except the home page.
 *
...
export default function Header() {
  ...
  // Hides the back button on the home page
